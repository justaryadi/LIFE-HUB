        ...
        <>
            <nav className="feature-navbar" style={{ justifyContent: isMobile ? 'space-between' : 'center' }}>
                ...
                {!isMobile && (
                    <div className="nav-pill">
                        ...
                        <a href="pomodoro.html"><span>Pomodoro</span></a>
                        <a href="achievement.html" className="active"><span>Achievement</span></a>
            ...
            {isMobile && isMenuOpen && (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', padding: '16px', background: 'white', borderBottom: '1px solid #99F6E4' }}>
                    ...
                    <a href="pomodoro.html" style={{ textDecoration: 'none', color: '#475569', fontWeight: '700' }}>Pomodoro</a>
                    <a href="achievement.html" style={{ textDecoration: 'none', color: '#14B8A6', fontWeight: '700' }}>Achievement</a>
